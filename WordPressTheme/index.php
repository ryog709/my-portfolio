        ...
        <section class="top-limited layout-top-limited">
            <div class="top-limited__inner inner">
                <div class="top-limited__header">
                    <div class="top-limited__title-wrap section-title">
    ...
    <section class="top-information layout-top-information">
        <div class="top-information__inner inner">
            <div class="top-information__title-wrap section-title">
                <span class="section-title__sub section-title__sub--white">category</span>
                <h2 class="section-title__main section-title__main--white">カテゴリー</h2>
            </div>
            <div class="top-information__wrap">
                <div class="top-information__image colorbox js-colorbox">
                    <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/img013.webp" alt="チョコレート" width="345" height="227" loading="lazy" />
                </div>
        ...
        <section class="top-blog layout-top-blog">
            <div class="top-blog__inner">
                <div class="top-blog__title-wrap section-title">
                    <span class="section-title__sub section-title__sub--white">staff&nbsp;blog</span>
                    <h2 class="section-title__main section-title__main--white">スタッフブログ</h2>
                </div>
        ...
        <section class="top-price layout-top-price">
            <div class="top-price__inner inner">
                <div class="top-price__title-wrap section-title">
                    <span class="section-title__sub section-title__sub--white">price</span>
                    <h2 class="section-title__main section-title__main--white">プライス</h2>
                </div>
                <div class="top-price__container">
                    ...
                    <picture class="top-price__image colorbox js-colorbox">
                        ...
                        <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/top-price-img.webp" alt="飾りつけられたチョコレート" width="345" height="227" loading="lazy" />
                    </picture>
                </div>
